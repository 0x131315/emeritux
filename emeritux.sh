...
# This Bash script allows you to easily and safely download, install or update Enlightenment 0.23 (aka E23)
...
doxygen faenza-icon-theme git gstreamer1.0-libav gstreamer1.0-plugins-bad \
...
libcurl4-gnutls-dev libgnutls28-dev libgstreamer1.0-dev \
